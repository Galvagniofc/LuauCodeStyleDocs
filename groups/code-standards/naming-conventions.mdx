...
Consistent naming conventions are fundamental to writing maintainable code. They reduce cognitive load, improve readability, and make collaboration more efficient. The conventions prioritize clarity and consistency above all else.

## Naming

> ### PascalCase for "Everything"
>
> I use `PascalCase` for all identifiers in codebase. This creates a uniform, professional appearance and eliminates decision fatigue.
>
> <Note>
