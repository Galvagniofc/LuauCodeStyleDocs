...
description: "Our core philosophy: structuring data for optimal performance and maintainability, prioritizing systems over objects."
---

Data-Oriented Design is the cornerstone of our development philosophy. Unlike Object-Oriented Programming (OOP), which focuses on encapsulating data and behavior into objects, DOD focuses on organizing and structuring **data** for optimal processing and performance.

In Games development, this approach is critical for managing large numbers of entities (e.g., bullets, enemies, particles) efficiently, leading to better **cache locality** and easier **parallelization**.

<Note>
  I personally prefer using DOD over OOP, even in cases where it doesn’t make any noticeable difference in performance.
</Note>
