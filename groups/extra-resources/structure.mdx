---
title: "Structure"
description: "A well-organized project structure is the foundation of maintainable and scalable Roblox development. My structure follows clear separation of concerns and promotes code reusability across different contexts."
---
...
Git Command to get the folder structure:\
`git clone https://github.com/Galvagniofc/Folder-Structure.git`

<Warning>
  This structure is specifically designed and strongly recommended for Multi-Script Architecture development.
</Warning>
...
<Expandable title="Shared">
  ...
  **The Shared folder contains code that can be used by both client and server.**
  ...
  - `Modules`
    ...
    Reusable server/client-side modules that handle specific functionality. 

    ㅤ
  - `Types`

    Type definitions used throughout the codebase. Essential for maintaining type safety. ㅤ
  - `Utils`
